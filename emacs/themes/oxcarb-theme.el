...
(autothemer-deftheme
 oxcarb "A theme based on oxocarbon amazing color scheme"
 ...
 (
  ...
  ;; ;; Font lock
  (font-lock-keyword-face               (:foreground foam :weight 'semi-bold))
  (font-lock-type-face                  (:foreground iris :weight 'semi-bold))
  (font-lock-builtin-face               (:foreground foam))
  (font-lock-function-name-face         (:foreground pink :weight 'semi-bold))
  ...
  (font-lock-preprocessor-face	   		(:foreground foam))
  ...
  (org-level-1                          (:foreground love :height 1.2 :bold t))
  (org-level-2                          (:foreground iris :height 1.1 :bold t))
  ...
  (tree-sitter-hl-face:function.special          (:foreground green :bold t))
  ...
  (tree-sitter-hl-face:type.parameter            (:foreground gold))
  ...
  (tree-sitter-hl-face:variable.builtin          (:foreground foam))

  (tree-sitter-hl-face:variable.special          (:foreground iris))
  (tree-sitter-hl-face:variable.synthesized      (:foreground love))
  ...
  (tree-sitter-hl-face:label                     (:foreground unmuted))
  ...
  (tree-sitter-hl-face:include                   (:foreground dark-foam :italic t :bold t))
